...
import { createItemAction, type ItemInput } from "@/server/actions/item.actions";
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input id="name" name="name" required placeholder="e.g., Cement Bag" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="category">Category</Label>
                <Input id="category" name="category" placeholder="e.g., Construction" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="space-y-2">
                ...
                <Input id="unit" name="unit" required placeholder="e.g., Bag, Kg, Pc" />
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Input id="sellingPrice" name="sellingPrice" type="number" step="0.01" required placeholder="0.00" />
              </div>
            </div>
